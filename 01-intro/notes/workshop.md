...
1. [Environment](01-environment.md) - Prerequisites, setup, installing libraries, the use case
2. [What is RAG](02-rag.md) - LLMs, the RAG idea, RAG vs fine-tuning
3. [Search](03-search.md) - Fetching data, minsearch index, filtering, boosting
4. [Building the Prompt](04-building-prompt.md) - Prompt template, context, build_prompt
5. [The LLM](05-llm.md) - The LLM function, OpenAI API
6. [Full RAG](06-full-rag.md) - Wiring it together, the complete pipeline
7. [Data Ingestion](07-data-ingestion.md) - Ingestion script, sqlitesearch, two-process architecture
8. [Next Steps](08-next-steps.md) - Vector search, Elasticsearch, agents, evaluation, monitoring
