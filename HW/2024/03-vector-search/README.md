...
## 3.1 Введение в поиск по вектору
...
## 3.2 Семантический поиск с помощью Elasticsearch
...
### 3.2.2 Расширенный семантический поиск
...
* [Показатели оценки](eval/evaluation-metrics.md)
...
(3.3.3 Оценка ранжирования: поиск текста)
