...
When we put the LLM in control, our system becomes agentic: flexible,
not rigid.
...
We'll build on top of the RAG pipeline from Part 1 (keyword search with
minsearch). If you skipped Part 1, the next lesson does a quick
revision and walks you through downloading the helpers.
