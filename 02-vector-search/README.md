...
3. [Vector Search with MinSearch](lessons/03-minsearch-vector.md) - In-memory vector search
4. [RAG with Vector Search](lessons/04-rag-vector.md) - Replacing keyword search with vector search in our RAG pipeline
5. [Vector Search with sqlitesearch](lessons/05-sqlitesearch-vector.md) - Persistent vector search backed by SQLite
6. [Vector Search with PGVector](lessons/06-pgvector.md) - Production vector search with PostgreSQL and pgvector
7. [Text vs Vector Search](lessons/07-text-vs-vector.md) - Comparing keyword and vector search side by side
8. [Hybrid Search](lessons/08-hybrid-search.md) (Optional) - Combining keyword and vector search for better results
