...
![The app with +1 and -1 buttons below the answer](images/08-user-feedback-06-app-feedback-buttons-crisp.png)
...
![Clicking +1 shows the thanks confirmation](images/08-user-feedback-07-thanks-after-click-crisp.png)
