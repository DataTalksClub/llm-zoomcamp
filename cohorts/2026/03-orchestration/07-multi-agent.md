...
![The multi-agent research flow with the main analyst agent and its system message](images/07-multi-agent-01-multi-agent-flow-crisp.png)
...
![The multi-agent execution with the research results and the JSON output in the logs](images/07-multi-agent-02-research-output-logs-crisp.png)
...
![The flow execution timeline showing how long each agent task ran](images/07-multi-agent-03-execution-durations-crisp.png)
