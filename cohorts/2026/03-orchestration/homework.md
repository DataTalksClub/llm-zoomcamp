...
2. Kestra running locally with API keys configured (see the [Setup](03-setup.md) lesson) -- this includes the Gemini API key, which is also required for the AI Copilot
