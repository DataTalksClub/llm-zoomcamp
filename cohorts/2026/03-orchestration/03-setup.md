...
![Secure Kestra setup with Docker Compose, API keys stored as environment secrets, and flows running in Kestra](images/03-setup-01-secure-kestra-setup-imagegen.png)
