...
3. [Generating Ground Truth for All Documents](03-ground-truth-batch.md) - Batch generation, cost, and prepared data
4. [Search Evaluation](04-search-evaluation.md) - Search setup and relevance lists
5. [Search Evaluation Metrics](05-search-metrics.md) - Hit Rate, MRR, the evaluate() function
6. [Search Parameter Tuning](06-search-tuning.md) - Using metrics to tune boost values
...
11. [RAG and Agent Evaluation](11-evaluation-intro.md) - What changes after retrieval
12. [Generating RAG Answers](12-rag-answers.md) - Running RAG on the ground truth questions
13. [LLM as a Judge](13-llm-as-judge.md) - Using an LLM to evaluate answer quality
14. [Agent Evaluation](14-agent-evaluation.md) - Capturing answers and tool-call trajectories
15. [Next Steps](15-next-steps.md) - Evaluation frameworks, monitoring, and resources
...
- [2025 cohort](../../2025/03-evaluation/)
