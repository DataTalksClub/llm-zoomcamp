...
![Vector similarity search maps a query vector to nearby document vectors and a ranked results list](images/10-next-steps-01-similarity-search-imagegen.png)
